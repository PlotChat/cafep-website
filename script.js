...
accounts = [{name: "admin", pass: "admin"}, {name: "Bob", pass: "BobTheBest"}];
...
function signin(){
    ...
    if (accountNameInput != "" && accountpassInput != ""){
        if (account in accounts){
            ...
            $("#modalp").text("This account doesn't exist. Do you want to signup with this information?");
            $("#signupBtn").show();
...
function showToast(itemName, itemPrice) {
    ...
    toastText.innerHTML = itemName + " (" + itemPrice + ") has been added to cart!";
